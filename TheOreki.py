...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await idk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await idk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await idk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await ydk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await ydk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await ydk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await wdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await wdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await wdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await hdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await hdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await hdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await sdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await sdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await sdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await adk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await adk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await adk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await bdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await bdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await bdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await cdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await cdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await cdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await ddk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await ddk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await ddk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await edk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await edk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await edk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await vdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await vdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await vdk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await kkk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await kkk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await kkk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await ljk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await ljk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await ljk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await ljk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await mkk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await mkk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await mkk(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await sid(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await sid(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await sid(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await shy(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await shy(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await shy(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if seeee:
        ...
        try:
            ...
            await aam(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await aam(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await aam(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await aam(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await ake(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await ake(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await ake(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await eel(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await eel(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await eel(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await khu(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await khu(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await khu(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await shi(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await shi(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await shi(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await yaa(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await yaa(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await yaa(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await dav(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await dav(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await dav(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await raj(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await raj(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await raj(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await put(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await put(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            await put(functions.channels.JoinChannelRequest(channel="@OrekiMusicBot_support"))
            botid = telethon.utils.get_peer_id(botme)
